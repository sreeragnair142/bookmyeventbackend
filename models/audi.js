...
auditoriumSchema.index({ zone: 1, isActive: 1, isApproved: 1 });
auditoriumSchema.index({ isFeatured: 1, isActive: 1 });
auditoriumSchema.index({ ownerEmail: 1 });
auditoriumSchema.index({ location: '2dsphere' });
